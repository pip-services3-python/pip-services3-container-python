...
"""
    ...
    If objects implement the IOpenable interface, the <code>open()</code> method is called and they start to work.
    ...
    [[RunReferencesDecorator Run]] - ReferenceDecorators are used during the corresponding building, linking,
